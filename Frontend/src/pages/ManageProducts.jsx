...
const ManageProducts = () => {
  ...
  //     (product) =>
  //       (!startDate ||
  //         new Date(product.valid_from) >= new Date(startDate)) &&
  //       (!endDate || new Date(product.valid_till) <= new Date(endDate))
  //   );
  ...
  const handleSearch = () => {
    const filtered = products.filter((product) => {
      ...
      const endDateValid = !endDate || new Date(product.valid_till) <= new Date(endDate);
      ...
      <div className="flex">
        ...
        <div className="flex-grow">
          ...
          <div className="bg-white p-4 rounded-lg">
            <div className="relative w-[77.75rem] h-[3.5625rem]">
              ...
              <div className="absolute w-[20rem] h-[3.5625rem] top-0 left-[20.4375rem]">
                <div className="w-[17rem] relative h-[3.5625rem] bg-white rounded-[2.8125rem] border border-solid border-[#a8a8a8]">
                  ...
                  <input
                    ...
                    className="absolute w-[7.125rem] top-[1.625rem] left-[1.25rem] font-medium text-[#777777] text-[1rem] tracking-[0] leading-[normal]"
                  />
                </div>
              </div>
              <div className="inline-flex items-center justify-center gap-[0.625rem] px-[8rem] py-[1rem] absolute top-0 left-[41.4375rem] w-[18rem] h-[3.5625rem] bg-black rounded-[2.8125rem] overflow-hidden border border-solid border-[#a8a8a8]">
                <button
                  className="relative w-fit mt-[-0.0625rem] font-medium text-[#ffffff] text-[1rem] tracking-[0] leading-[normal]"
